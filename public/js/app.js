...
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_3__registerServiceWorker__ = __webpack_require__(14);
...
if (document.getElementById('app-react')) {
    __WEBPACK_IMPORTED_MODULE_0_react_dom___default.a.render(__WEBPACK_IMPORTED_MODULE_1_react___default.a.createElement(__WEBPACK_IMPORTED_MODULE_2__components_App__["a" /* default */], null), document.getElementById('app-react'));
}
...
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_2__pages_entregas_CreateEntrega__ = __webpack_require__(65);
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_3__pages_entregas_IndexEntrega__ = __webpack_require__(64);
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_4__pages_AbrirEntrega__ = __webpack_require__(66);
            ...
            return __WEBPACK_IMPORTED_MODULE_0_react___default.a.createElement(
                ...
                __WEBPACK_IMPORTED_MODULE_0_react___default.a.createElement(
                    ...
                    __WEBPACK_IMPORTED_MODULE_0_react___default.a.createElement(
                        ...
                        __WEBPACK_IMPORTED_MODULE_0_react___default.a.createElement(__WEBPACK_IMPORTED_MODULE_1_react_router_dom__["c" /* Route */], { exact: true, path: "/", component: __WEBPACK_IMPORTED_MODULE_3__pages_entregas_IndexEntrega__["a" /* default */] }),
                        __WEBPACK_IMPORTED_MODULE_0_react___default.a.createElement(__WEBPACK_IMPORTED_MODULE_1_react_router_dom__["c" /* Route */], { path: "/nova", component: __WEBPACK_IMPORTED_MODULE_2__pages_entregas_CreateEntrega__["a" /* default */] }),
                        __WEBPACK_IMPORTED_MODULE_0_react___default.a.createElement(__WEBPACK_IMPORTED_MODULE_1_react_router_dom__["c" /* Route */], { path: "/abrir/:id", component: __WEBPACK_IMPORTED_MODULE_4__pages_AbrirEntrega__["a" /* default */] })
                    ),
                    __WEBPACK_IMPORTED_MODULE_0_react___default.a.createElement(
                        "footer",
                        ...
                        __WEBPACK_IMPORTED_MODULE_0_react___default.a.createElement(
                            ...
                            __WEBPACK_IMPORTED_MODULE_0_react___default.a.createElement(
                                ...
                                "\xA9 App Unica | Todos os direitos reservados"
                            )
                        )
                    )
                )
...
var IndexEntrega = function (_Component) {
    _inherits(IndexEntrega, _Component);

    function IndexEntrega(props) {
        _classCallCheck(this, IndexEntrega);

        var _this = _possibleConstructorReturn(this, (IndexEntrega.__proto__ || Object.getPrototypeOf(IndexEntrega)).call(this, props));
    ...
    _createClass(IndexEntrega, [{
        key: "componentDidMount",
        value: function componentDidMount() {
            var _this2 = this;

            fetch("/api/entregas").then(function (res) {
                return res.json();
        ...
        value: function handleSearch(e) {
            this.setState({
                entregas_filtradas: this.state.entregas.filter(function (item) {
            ...
            return __WEBPACK_IMPORTED_MODULE_0_react___default.a.createElement(
                ...
                __WEBPACK_IMPORTED_MODULE_0_react___default.a.createElement(
                    ...
                    __WEBPACK_IMPORTED_MODULE_0_react___default.a.createElement(
                        ...
                        __WEBPACK_IMPORTED_MODULE_0_react___default.a.createElement(
                            __WEBPACK_IMPORTED_MODULE_1_react_router_dom__["b" /* Link */],
                            { to: '/nova', className: "btn btn-dark" },
                            __WEBPACK_IMPORTED_MODULE_0_react___default.a.createElement("span", { className: "fa fa-plus" }),
                            "\xA0Nova Entrega"
                        )
                    )
                ),
                __WEBPACK_IMPORTED_MODULE_0_react___default.a.createElement(
                    ...
                    __WEBPACK_IMPORTED_MODULE_0_react___default.a.createElement(
                        "div",
                        { className: "col-12" },
                        __WEBPACK_IMPORTED_MODULE_0_react___default.a.createElement("input", { type: "text", onKeyUp: this.handleSearch, className: "form-control", placeholder: "Buscar por Cliente" })
                    )
                ),
                __WEBPACK_IMPORTED_MODULE_0_react___default.a.createElement(
                    "div",
                    { className: "row" },
                    this.state.entregas_filtradas.length > 0 ? this.state.entregas_filtradas.map(function (item) {
                        return __WEBPACK_IMPORTED_MODULE_0_react___default.a.createElement(
                            "div",
                            { className: "col-sm-4 col-12 mt-4", key: item.id },
                            __WEBPACK_IMPORTED_MODULE_0_react___default.a.createElement(
                                "div",
...
/* harmony default export */ __webpack_exports__["a"] = (IndexEntrega);
...
var CreateEntrega = function (_Component) {
    _inherits(CreateEntrega, _Component);

    function CreateEntrega(props) {
        _classCallCheck(this, CreateEntrega);

        var _this = _possibleConstructorReturn(this, (CreateEntrega.__proto__ || Object.getPrototypeOf(CreateEntrega)).call(this, props));
    ...
    _createClass(CreateEntrega, [{
        ...
        value: function render() {
            return __WEBPACK_IMPORTED_MODULE_0_react___default.a.createElement(
                ...
                __WEBPACK_IMPORTED_MODULE_0_react___default.a.createElement(
                    ...
                    __WEBPACK_IMPORTED_MODULE_0_react___default.a.createElement(
                        __WEBPACK_IMPORTED_MODULE_1_react_router_dom__["b" /* Link */],
                        { to: '/', className: 'btn btn-dark btn-sm' },
                        __WEBPACK_IMPORTED_MODULE_0_react___default.a.createElement('span', { className: 'fa fa-arrow-left' })
                    )
                ),
                __WEBPACK_IMPORTED_MODULE_0_react___default.a.createElement(
                    'h3',
                    { className: 'pull-left ml-3' },
                    'Nova Entrega'
                ),
                ...
                __WEBPACK_IMPORTED_MODULE_0_react___default.a.createElement(
                    ...
                    __WEBPACK_IMPORTED_MODULE_0_react___default.a.createElement(
                        ...
                        __WEBPACK_IMPORTED_MODULE_0_react___default.a.createElement(
                            'div',
                            { className: 'form-group row ' + (this.hasValidador('cliente') ? 'has-error' : '') },
                            __WEBPACK_IMPORTED_MODULE_0_react___default.a.createElement(
                                'label',
                                { htmlFor: 'inputCliente', className: 'col-sm-2 col-form-label required' },
                                'Nome do Cliente'
                            ),
                            __WEBPACK_IMPORTED_MODULE_0_react___default.a.createElement(
                                'div',
                                { className: 'col-sm-6' },
                                __WEBPACK_IMPORTED_MODULE_0_react___default.a.createElement('input', { type: 'text', className: 'form-control', id: 'inputCliente',
                        ...
                        __WEBPACK_IMPORTED_MODULE_0_react___default.a.createElement(
                            'div',
                            { className: 'form-group row ' + (this.hasValidador('data_entrega') ? 'has-error' : '') },
                            __WEBPACK_IMPORTED_MODULE_0_react___default.a.createElement(
                                'label',
                                { htmlFor: 'inputDataEntrega', className: 'col-sm-2 col-form-label required' },
                                'Data de Entrega'
                            ),
                            __WEBPACK_IMPORTED_MODULE_0_react___default.a.createElement(
                                'div',
                                { className: 'col-sm-6' },
                                __WEBPACK_IMPORTED_MODULE_0_react___default.a.createElement('input', { type: 'date', className: 'form-control', id: 'inputDataEntrega',
                        ...
                        __WEBPACK_IMPORTED_MODULE_0_react___default.a.createElement(
                            'div',
                            { className: 'form-group row ' + (this.hasValidador('endereco_origem') ? 'has-error' : '') },
                            __WEBPACK_IMPORTED_MODULE_0_react___default.a.createElement(
                                'label',
                                { htmlFor: 'inputCliente', className: 'col-sm-2 col-form-label required' },
                                'Endere\xE7o de Partida'
                            ),
                            __WEBPACK_IMPORTED_MODULE_0_react___default.a.createElement(
                                'div',
                                { className: 'col-sm-6' },
                                __WEBPACK_IMPORTED_MODULE_0_react___default.a.createElement('input', { type: 'text', className: 'form-control', id: 'inputCliente',
                                    placeholder: 'Endere\xE7o de Partida', name: 'endereco_origem',
                        ...
                        __WEBPACK_IMPORTED_MODULE_0_react___default.a.createElement(
                            'div',
                            { className: 'form-group row ' + (this.hasValidador('endereco_destino') ? 'has-error' : '') },
                            __WEBPACK_IMPORTED_MODULE_0_react___default.a.createElement(
                                'label',
                                { htmlFor: 'inputCliente', className: 'col-sm-2 col-form-label required' },
                                'Endere\xE7o de Destino'
                            ),
                            __WEBPACK_IMPORTED_MODULE_0_react___default.a.createElement(
                                'div',
                                { className: 'col-sm-6' },
                                __WEBPACK_IMPORTED_MODULE_0_react___default.a.createElement('input', { type: 'text', className: 'form-control', id: 'inputCliente',
                                    placeholder: 'Endere\xE7o de Destino', name: 'endereco_destino',
                    ...
                    __WEBPACK_IMPORTED_MODULE_0_react___default.a.createElement(
                        ...
                        __WEBPACK_IMPORTED_MODULE_0_react___default.a.createElement(
                            'button',
                            { className: 'btn btn-secondary ml-3', onClick: this.handleReset },
                            'Reset'
                        )
                    )
                )
        ...
        key: 'handleValidators',
        value: function handleValidators() {
...
/* harmony default export */ __webpack_exports__["a"] = (CreateEntrega);
...
var AbrirEntrega = function (_Component) {
    _inherits(AbrirEntrega, _Component);

    function AbrirEntrega(props) {
        _classCallCheck(this, AbrirEntrega);

        var _this = _possibleConstructorReturn(this, (AbrirEntrega.__proto__ || Object.getPrototypeOf(AbrirEntrega)).call(this, props));
    ...
    _createClass(AbrirEntrega, [{
        key: "componentDidMount",
        value: function componentDidMount() {
            var _this2 = this;

            fetch("/api/entregas/" + this.props.match.params.id).then(function (res) {
                return res.json();
            }).then(function (result) {
                _this2.setState({
                    entrega: result.data
        ...
        value: function render() {
            if (!this.state.entrega) {
                return __WEBPACK_IMPORTED_MODULE_0_react___default.a.createElement(
                    "div",
                    null,
                    __WEBPACK_IMPORTED_MODULE_0_react___default.a.createElement("i", { className: "fa fa-spin fa-pulse fa-3x fa-fw" }),
                    "Carregando"
                );
            }
...
/* harmony default export */ __webpack_exports__["a"] = (AbrirEntrega);
